    ...
    <table id='t1'>
      <thead>
        ...
        <tr>
          ...
          <th id='rating'></th>
          <th id='t_avg'>12PM_AVG</th>
          <th id='t_avg'>1PM_AVG</th>
          <th id='t_avg'>7PM_AVG</th>
          <th id='t_avg'>8PM_AVG</th>
        </tr>
      </thead>
      <tbody>";
      ...
      while($row10 = $result10->fetch_assoc()){
        var_dump($row10);
            ...
            if($row10['customer_ID'] == $x) {
                ...
                echo "weight " . $weight;
                echo "<br>";
                echo "rating " . $rating8[$x];
                echo "<br>";
                echo "<br>";
                if($weight < $rating8[$x]){
                    echo "The rating ". $weight . " is less than  " . $rating8[$x] . " for customer ID: " . $x;
                    echo "<br>";
